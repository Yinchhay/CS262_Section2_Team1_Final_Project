    ...
    <div class="container-fluid poppins">
        <div class="row">
            <div class="col-lg-12 text-start dark-purple">
                <span class="fs-30">Online Tests</span>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-4">
            ...
            <div class="col-2 text-end">
                <a href="{{ route('test.create') }}"><button type="button" class="btn bg-bluepurple"
                ...
                <div class="poster-group">
                    <div class="poster">
                        <a href="" class="text-decoration-none text-black">
                            <img src="{{ asset('images/english_online_test_image.png') }}" class="poster-image" alt=""
                                height="229">
                            <div class="poster-title">
                                <small>English online test beginner 2024 January</small>
                            </div>
                        </a>
                    </div>
                    <div class="poster">
                    ...
                    <div class="poster">
                        <a href="" class="text-decoration-none text-black">
                            <img src="{{ asset('images/english_online_test_image.png') }}" class="poster-image"
                                alt="" height="229">
                            <div class="poster-title">
                                <small>English online test beginner 2024 January</small>
                            </div>
                    ...
                    <div class="poster">
                        <a href="" class="text-decoration-none text-black">
                            <img src="{{ asset('images/english_online_test_image.png') }}" class="poster-image"
                                alt="" height="229">
                            <div class="poster-title">
                                <small>English online test intermediate 2024 January</small>
                            </div>
                        </a>
                    </div>
                    <div class="poster">
