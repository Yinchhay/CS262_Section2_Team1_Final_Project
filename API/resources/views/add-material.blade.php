            ...
            <div class="col-12 text-start dark-purple">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb align-items-baseline">
                        <li class="breadcrumb-item fs-30"><a href="{{ route('material.index') }}"
                    ...
                    <div class="poster-result">
                        <div class="poster gap-4">
                            <div class="poster-img">
                                <img src="{{ asset('images/english_material_sample_poster.png') }}" alt="poster"
                                    height="285">
