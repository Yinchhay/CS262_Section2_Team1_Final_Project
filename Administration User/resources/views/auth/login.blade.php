...
<head>
    ...
    <title>PROFICIENTIA | Login</title>
    ...
    <div class="d-flex justify-content-center vh-100 align-items-center">
        <form action="{{ route('login') }}" method="POST" class="form">
            ...
            <div class="logo saria-condensed d-flex flex-row align-items-center">
                <img src="{{ asset('images/proficientia_logo.png') }}" alt="PROFICIENTIA" width="60" height="60"
            ...
            <h3 class="text-center m-0 mb-3 dark-purple">Login</h3>
            ...
            <div class="text-center">
                <button type="submit" class="btn bg-bluepurple">Login</button>
            </div>
        </form>
    </div>
